<table border="0" cellpadding="0" cellspacing="0"
  ...
  <tr>
    <td style="font-family: 'Proxima Nova','Arial', 'Helvetica Neue',Helvetica, sans-serif;">
      <p style="font-size: 20px; font-weight: 600;">Hi,</p>
      <p style="font-color: color: #737373;">You are receiving this email because you have subscribed to ThirdEye Alert Service for <strong>'${alertConfigName}'</strong>.</p>
...
<#if anomalyDetails?has_content>
  ...
  <tr style="margin: 24px;">
    <td style="font-family:'Proxima Nova','Arial', 'Helvetica Neue',Helvetica, sans-serif;font-size:14px; font-color: color: #737373;font-weight:300; width:100%;display:inline; text-align: center;">
      <br/>
      <hr/>
